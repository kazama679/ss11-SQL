...
-- 3
create index idx_employees_branchid_salary on employees(branchid, salary);
EXPLAIN SELECT * FROM Employees WHERE BranchID = 1 AND Salary > 20000000;

-- 4
create unique index idx_accounts_accountid_customerid on accounts(accountid, customerid);
