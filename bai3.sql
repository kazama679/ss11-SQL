...
3.2
delimiter &&
create procedure GetCustomerByPhone(PhoneNumber varchar(15))
begin 
	select CustomerID, FullName, DateOfBirth, Address, Email from customers c 
...
-- 3.3
delimiter &&
create procedure GetTotalBalance(CustomerID int, out TotalBalance decimal(15,2))
begin 
	select a.CustomerID, sum(a.Balance) as TotalBalance from accounts a
...
-- 3.4
delimiter &&
create procedure IncreaseEmployeeSalary(EmployeeID int, inout Salary decimal(10,2))
begin 
	update employees e
